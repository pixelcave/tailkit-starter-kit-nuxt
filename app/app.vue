  ...
  >
    ...
    >
      ...
      <div>
        ...
        >
          Carefully crafted, easy to customize, fully responsive UI Components,
          Templates and Tools for your Tailwind CSS based projects.
        </h2>
        <div class="mt-8 flex flex-wrap justify-center gap-3 sm:items-center">
          <a
            href="https://tailkit.com/login"
            target="_blank"
            class="focus:outline-hidden group inline-flex w-full items-center justify-center gap-2 rounded-lg border border-blue-700 bg-blue-700 p-3 text-sm font-semibold leading-5 text-white transition hover:border-blue-800 hover:bg-blue-800 hover:text-white focus:ring-2 focus:ring-blue-500/50 active:border-blue-700 active:bg-blue-700 sm:w-auto sm:px-4"
          >
            <svg
          ...
          <a
            ...
            target="_blank"
            class="hover:shadow-xs focus:outline-hidden group inline-flex w-full items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white p-3 text-sm font-semibold leading-5 text-gray-800 transition hover:border-gray-300 hover:text-gray-900 focus:ring-2 focus:ring-gray-300/25 active:border-gray-200 active:shadow-none sm:w-auto sm:px-4 dark:border-gray-700 dark:bg-transparent dark:text-gray-300 dark:hover:border-gray-600 dark:hover:text-gray-200 dark:focus:ring-gray-600/50 dark:active:border-gray-700"
          >
            <svg
